...
; Example .......: No
; ===============================================================================================================================
Func __Android_GetBatteryInfo($aDevice,$sMode)
	Local $aOutput = StringRegExp(_Android_Shell($aDevice,"dumpsys battery"), $sMode & ":(.*)", 3)
...
Func __Run($sCommand)
	...
	$sCommand = @WorkingDir&'\package\scrcpy\' & $sCommand
	$iPID = Run($sCommand, @WorkingDir&'\package\scrcpy\' , @SW_HIDE, $STDERR_CHILD + $STDOUT_CHILD)
	;While 1
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetBatteryLevel($aDevice)
	Return (__Android_GetBatteryInfo($aDevice,"level") * 100) / __Android_GetBatteryInfo($aDevice,"scale")
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetBatteryTemperature($aDevice)
	Return __Android_GetBatteryInfo($aDevice,"temperature")
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetBatteryVoltage($aDevice)
	Return __Android_GetBatteryInfo($aDevice,"voltage")
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _Android_GetDevices
; Description ...:
; Syntax ........: _Android_GetDevices
; Parameters ....:
; Return values .: None
; Author ........: Kyaw Swar Thwin
; Modified ......:
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetDevices()
	Local $aOutput = StringSplit(__Run("adb devices"), @LF)
	Local $iCount = 0;
	For $i = 0 To UBound($aOutput) -1
		If StringInStr($aOutput[$i],"devices",2) > 0 Then
			ContinueLoop
		EndIf
		If StringInStr($aOutput[$i],"device",2) <> 0  then
			$iCount += 1
		EndIf
	Next
	Local $aDevices[$iCount];
	Local $iCountDevices = 0;
	For $i = 0 To UBound($aOutput) -1
		If StringInStr($aOutput[$i],"devices",2) > 0 Then
			ContinueLoop
		EndIf
		If StringInStr($aOutput[$i],"device",2) <> 0  Then
			$aDevices[$iCountDevices] = StringStripWS(StringReplace($aOutput[$i],"device",""),8)
			$iCountDevices += 1
		EndIf
	Next
	If Not @error Then Return $aDevices
	EndFunc   ;==>_Android_GetDevices
	
; #FUNCTION# ======================================================================================================================
; Name ..........: _Android_GetDeviceName
; Description ...:
; Syntax ........: _Android_GetDeviceName
; Parameters ....:
; Return values .: None
; Author ........: Kyaw Swar Thwin
; Modified ......:
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetDeviceName($aDevice)
	Dim $iDevice[9]
	$iDevice[0] = _Android_GetProperty($aDevice,"ro.product.device")
	$iDevice[1] = _Android_GetProperty($aDevice,"ro.product.manufacturer")
	$iDevice[2] = _Android_GetProperty($aDevice,"ro.product.name")
	$iDevice[3] = _Android_GetProperty($aDevice,"ro.product.brand")
	$iDevice[4] = _Android_GetProperty($aDevice,"ro.product.model")
	$iDevice[5] = _Android_GetProperty($aDevice,"ro.build.fingerprint")
	$iDevice[6] = _Android_GetProperty($aDevice,"ro.product.board")
	$iDevice[7] = _Android_GetProperty($aDevice,"ro.build.id")
	$iDevice[8] = _Android_GetProperty($aDevice,"ro.build.version.release")
	If @error Then Return 
	If Not @error Then Return $iDevice
EndFunc   ;==>_Android_GetDeviceName

; #FUNCTION# ====================================================================================================================
; Name ..........: _Android_GetMeminfo
; Description ...:
; Syntax ........: _Android_GetMeminfo
; Parameters ....:
; Return values .: None
; Author ........: Kyaw Swar Thwin
; Modified ......:
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetMeminfo($aDevice)
	; .\adb.exe -s R58NC148A9N shell "cat /proc/meminfo"
	; Free = MemFree + MemAvailable
	Local $aOutput = __Run('adb -s ' & $aDevice & ' shell "cat /proc/meminfo"') 
	$aOutputNumber   =  StringRegExp($aOutput , "(?:\s*)?(.+)(?:\n)?", 3)
	if UBound($aOutputNumber) > 0 Then
		Dim $aMemInfo[3]
		$totalMem = StringRegExpReplace($aOutputNumber[0], "\D", "")
		$freeMem = StringRegExpReplace($aOutputNumber[1], "\D", "") + StringRegExpReplace($aOutputNumber[2], "\D", "")
		$UsedMem = $totalMem - $freeMem
		$aMemInfo[0] = StringFormat('%.1f', $totalMem/(1024*1024))
		$aMemInfo[1] = StringFormat('%.1f',$freeMem/(1024*1024))
		$aMemInfo[2] = StringFormat('%.1f',$UsedMem/(1024*1024))
	Else 
		Dim $aMemInfo[0]
		Return $aMemInfo
	EndIf

	If Not @error Then Return $aMemInfo
	EndFunc   ;==>_Android_GetMeminfo
; #FUNCTION# ====================================================================================================================
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetNetworkCountryISO($aDevice)
	Return _Android_GetProperty($aDevice,$PROPERTY_OPERATOR_ISO_COUNTRY)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetNetworkOperator($aDevice)
	Return _Android_GetProperty($aDevice,$PROPERTY_OPERATOR_NUMERIC)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetNetworkOperatorName($aDevice)
	Return _Android_GetProperty($aDevice,$PROPERTY_OPERATOR_ALPHA)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetNetworkType($aDevice)
	Switch _Android_GetNetworkTypeName($aDevice)
		Case "GPRS"
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetNetworkTypeName($aDevice)
	Return _Android_GetProperty($aDevice,$PROPERTY_DATA_NETWORK_TYPE)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetPhoneType($aDevice)
	Return _Android_GetProperty($aDevice,$CURRENT_ACTIVE_PHONE)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetProperty($aDevice,$sKey)
	Return _Android_Shell($aDevice,"getprop " & $sKey)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetSIMCountryISO($aDevice)
	Return _Android_GetProperty($aDevice,$PROPERTY_ICC_OPERATOR_ISO_COUNTRY)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetSIMOperator($aDevice)
	Return _Android_GetProperty($aDevice,$PROPERTY_ICC_OPERATOR_NUMERIC)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetSIMOperatorName($aDevice)
	Return _Android_GetProperty($aDevice,$PROPERTY_ICC_OPERATOR_ALPHA)
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetSIMState($aDevice)
	Switch _Android_GetProperty($aDevice,$PROPERTY_SIM_STATE)
		Case "ABSENT"
...
; #FUNCTION# ====================================================================================================================
; Name ..........: _Android_GetGlobal
; Description ...:
; Syntax ........: _Android_GetGlobal()
; Parameters ....:
; Return values .: None
; Author ........: Kyaw Swar Thwin
; Modified ......:
...
; Example .......: No
; ===============================================================================================================================
Func _Android_GetGlobal($aDevice,$sKey)
		Return _Android_Shell($aDevice,"settings get global " & $sKey)
EndFunc   ;==>_Android_GetGlobal
...
; Description ...:
; Syntax ........: _Android_Install($iDevice,$sFilePath[, $iMode = 1[, $bReinstall = False]])
; Parameters ....: $sFilePath           - A string value.
...
; Example .......: No
; ===============================================================================================================================
Func _Android_Install($iDevice,$sFilePath, $iMode = 1, $bReinstall = False)
	Local $aOutput
	If $iMode = Default Then $iMode = 1
	If $bReinstall = Default Then $bReinstall = False
	If $iMode = 2 Then; Install on SD Card
		If $bReinstall Then
			$aOutput = StringSplit(__Run('adb -s '&$iDevice&' install -r -s "' & $sFilePath & '"'), @LF)
		Else
			$aOutput = StringSplit(__Run('adb -s '&$iDevice&' install -s "' & $sFilePath & '"'), @LF)
		EndIf
	Else; Install on Internal Storage
		If $bReinstall Then
			$aOutput = StringSplit(__Run('adb -s '&$iDevice&' install -r "' & $sFilePath & '"'), @LF)
		Else
			$aOutput = StringSplit(__Run('adb -s '&$iDevice&' install "' & $sFilePath & '"'), @LF)
		EndIf
	EndIf
...
; Example .......: No
; ===============================================================================================================================
Func _Android_IsAirplaneModeOn($aDevice)
	If _Android_GetProperty($aDevice,"ro.build.version.sdk") < 17 Then
		Return _Android_Shell($aDevice,"settings get system " & $AIRPLANE_MODE_ON) = 1
	Else
		Return _Android_Shell($aDevice,"settings get global " & $AIRPLANE_MODE_ON) = 1
	EndIf
...
; Example .......: No
; ===============================================================================================================================
Func _Android_IsBatteryPresent($aDevice)
	Return __Android_GetBatteryInfo($aDevice,"present") = "true"
...
; Example .......: No
; ===============================================================================================================================
Func _Android_IsNetworkRoaming($aDevice)
	Return _Android_GetProperty($aDevice,$PROPERTY_OPERATOR_ISROAMING) = "true"
...
; Example .......: No
; ===============================================================================================================================
Func _Android_IsAppInstalled($aDevice,$App)
	Local $aOutput
	$aOutput = _Android_Shell($aDevice,"  pm path " & $App)
	if $aOutput Then
	Return True
	Else
	Return False
...
; Example .......: No
; ===============================================================================================================================
Func _Android_Reboot($aDevice,$sMode = "")
	If $sMode = Default Then $sMode = ""
	Switch $sMode
		Case "recovery"
			If Not _Android_IsOnline() Then Return SetError(1, 0, 0)
			_Android_Shell($aDevice," reboot recovery")
		Case "bootloader"
			If _Android_IsBootloader() Then
				_Android_Shell($aDevice," fastboot reboot-bootloader")
			Else
				_Android_Shell($aDevice," reboot bootloader")
			EndIf
		Case "download"
			If Not _Android_IsOnline() Then Return SetError(1, 0, 0)
			If _Android_GetProperty("ro.product.manufacturer") <> "Samsung" Then Return SetError(2, 0, 0)
				_Android_Shell($aDevice,"  reboot download")
			Case "Shutdown"
				_Android_Shell($aDevice,"  reboot -p")
		Case Else
			If _Android_IsBootloader() Then
				_Android_Shell($aDevice,"  fastboot reboot")
			Else
				_Android_Shell($aDevice,"  reboot")
			EndIf
	EndSwitch
	Return 1
...
; Example .......: No
; ===============================================================================================================================
Func _Android_SendSMS($aDevice,$sPhoneNumber, $sSMSBody)
	If _Android_IsAppInstalled($aDevice,"com.android.shellms") Then
	Local $sOutput = _Android_Shell($aDevice, ' am startservice --user 0 -n com.android.shellms/.sendSMS -e contact "'&$sPhoneNumber&'" -e msg "'& $sSMSBody&'"')
	EndIf
	Return 1
...
; Example .......: No
; ===============================================================================================================================
Func _Android_Shell($aDevice,$sCommand, $bSuperuser = False, $bBusyBox = False)
	...
	If $bSuperuser Then
		If $bBusyBox Then
			...
			EndIf
		Else
			Return __Run('adb -s ' & $aDevice &' shell su -c "' & $sCommand & '"')
		EndIf
	Else
		If $bBusyBox Then
			If Not _Android_HasBusyBox() Then
			...
			EndIf
		Else
			Return __Run('adb -s ' & $aDevice &' shell "' & $sCommand & '"')
		EndIf
	EndIf
...
; Example .......: No
; ===============================================================================================================================
Func _Android_Uninstall($aDevice,$sPackage, $bKeepDataCache = False)
	Local $sOutput
	If $bKeepDataCache = Default Then $bKeepDataCache = False
	If $bKeepDataCache Then
		$sOutput = __Run("adb -s " & $aDevice & " uninstall -k " & $sPackage)
	Else
		$sOutput = __Run("adb " & $aDevice & " uninstall " & $sPackage)
	EndIf
